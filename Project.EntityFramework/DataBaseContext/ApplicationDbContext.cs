...
namespace Ettad.EntityFramework.DataBaseContext
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        public DbSet<WorkflowStepRequesterQuantityNotification> WorkflowStepRequesterQuantityNotifications { get; set; }
        public DbSet<WorkflowStepParallelRole> WorkflowStepParallelRoles { get; set; }
        ...
        public DbSet<RequestPurposeItemType> RequestPurposeItemTypes { get; set; }
