...
namespace Ettad.EntityFramework.Migrations
{
    ...
    [Migration("20260621055201_AddMaximumStockInAssets")]
    partial class AddMaximumStockInAssets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ettad.Data.Entities.AssetSupplyAccessoryDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AssetSupplyDetailId", "AccessoryId")
                        .IsUnique();

                    b.ToTable("AssetSupplyAccessoryDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.AttachmentRequirement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ParentType", "ParentId", "NameEn")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("AttachmentRequirements", (string)null);
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.BaseItem", b =>
                {
                    ...
                    b.Property<long?>("CriticalQuantity")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Ettad.Data.Entities.BaseItemPrimaryPurpos", b =>
                {
                    ...
                    b.HasKey("BaseItemId", "PrimaryPurposId");

                    b.HasIndex("PrimaryPurposId");

                    b.ToTable("BaseItemPrimaryPurposes", (string)null);
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Batch", b =>
                {
                    ...
                    b.HasIndex("DepotId", "BatchNumber")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Caliber", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Ettad.Data.Entities.FileUplodDetails", b =>
                {
                    ...
                    b.Property<long?>("AttachmentRequirementId")
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("AttachmentRequirementId");
            ...
            modelBuilder.Entity("Ettad.Data.Entities.HelpCenterContactDisplaySettings", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HelpCenterContactDisplaySettings", (string)null);
            ...
            modelBuilder.Entity("Ettad.Data.Entities.RequestItemWeaponAssociation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("AssociatedWeaponCaliberId")
                        .HasColumnType("bigint");

                    b.Property<long?>("AssociatedWeaponItemId")
                        .HasColumnType("bigint");

                    b.Property<string>("AssociatedWeaponOtherName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("RequestItemWeaponAssociations");
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.RequestPurpose", b =>
                {
                    ...
                    b.Property<int>("AllowanceContext")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3);
            ...
            modelBuilder.Entity("Ettad.Data.Entities.RequestPurposeItemType", b =>
                {
                    b.Property<long>("RequestPurposeId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("RequestPurposeId", "ItemType");

                    b.ToTable("RequestPurposeItemTypes", (string)null);
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Settings.OrderAutoRejectPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("NotifyRequester")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<string>("ScanCron")
                        .IsRequired()
                        .HasMaxLength(128)
                    ...
                    b.ToTable("OrderAutoRejectPolicies", (string)null);
                });

            modelBuilder.Entity("Ettad.Data.Entities.Settings.OrderAutoRejectPolicyNotifyRole", b =>
                {
                    ...
                    b.ToTable("OrderAutoRejectPolicyNotifyRoles", (string)null);
                });

            modelBuilder.Entity("Ettad.Data.Entities.Settings.OrderAutoRejectPolicyReminderDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PolicyId", "LeadDays")
                        .IsUnique();

                    b.ToTable("OrderAutoRejectPolicyReminderDays", (string)null);
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.UserDelegation", b =>
                {
                    ...
                    b.Property<string>("DelegatorRoleId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ettad.Data.Entities.WeaponAccessory", b =>
                {
                    ...
                    b.HasKey("WeaponId", "AccessoryId");

                    b.HasIndex("AccessoryId");

                    b.ToTable("WeaponAccessories", (string)null);
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Workflows.WorkflowApprovalStepReminder", b =>
                {
                    ...
                    b.HasIndex("WorkflowApprovalStepId", "LeadDays")
                        .IsUnique();
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Workflows.WorkflowStepRequesterQuantityNotification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("WorkflowStepRequesterQuantityNotifications", (string)null);
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Accessory", b =>
                {
            ...
            modelBuilder.Entity("Ettad.Comman.Idenitity.ApplicationUser", b =>
                {
                    b.HasOne("Ettad.CrossCutting.Comman.Idenitity.ApplicationRole", "DefaultRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Ettad.Data.Entities.AssetSupplyAccessoryDetail", b =>
                {
                    b.HasOne("Ettad.Data.Entities.BaseItem", "Accessory")
                        .WithMany()
            ...
            modelBuilder.Entity("Ettad.Data.Entities.BaseItemPrimaryPurpos", b =>
                {
                    b.HasOne("Ettad.Data.Entities.BaseItem", "BaseItem")
                        .WithMany("BaseItemPrimaryPurposes")
            ...
            modelBuilder.Entity("Ettad.Data.Entities.FileUplodDetails", b =>
                {
                    b.HasOne("Ettad.Data.Entities.AttachmentRequirement", "AttachmentRequirement")
                        .WithMany()
                        .HasForeignKey("AttachmentRequirementId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("AttachmentRequirement");
            ...
            modelBuilder.Entity("Ettad.Data.Entities.RequestPurposeItemType", b =>
                {
                    b.HasOne("Ettad.Data.Entities.RequestPurpose", "RequestPurpose")
                        .WithMany("RequestPurposeItemTypes")
                        .HasForeignKey("RequestPurposeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Settings.OrderAutoRejectPolicyNotifyRole", b =>
                {
                    b.HasOne("Ettad.Data.Entities.Settings.OrderAutoRejectPolicy", "Policy")
                        .WithMany("NotifyRoles")
            ...
            modelBuilder.Entity("Ettad.Data.Entities.WeaponAccessory", b =>
                {
                    b.HasOne("Ettad.Data.Entities.Accessory", "Accessory")
                        .WithMany("WeaponAccessories")
                        .HasForeignKey("AccessoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Ettad.Data.Entities.Weapon", "Weapon")
                        .WithMany("WeaponAccessories")
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Accessory", b =>
                {
                    b.HasOne("Ettad.Data.Entities.BaseItem", null)
                        .WithOne()
                        .HasForeignKey("Ettad.Data.Entities.Accessory", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Ammunition", b =>
                {
                    ...
                    b.HasOne("Ettad.Data.Entities.Caliber", "LookupCaliber")
                        .WithMany()
            ...
            modelBuilder.Entity("Ettad.Data.Entities.AssetSupplyDetail", b =>
                {
                    b.Navigation("AccessoryDetails");
                });

            modelBuilder.Entity("Ettad.Data.Entities.BaseItem", b =>
                {
                    b.Navigation("BaseItemPrimaryPurposes");
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.RequestItem", b =>
                {
                    b.Navigation("WeaponAssociations");
                });

            modelBuilder.Entity("Ettad.Data.Entities.RequestPurpose", b =>
                {
                    b.Navigation("RequestPurposeItemTypes");
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Settings.OrderAutoRejectPolicy", b =>
                {
                    b.Navigation("NotifyRoles");

                    b.Navigation("ReminderLeadDays");
                });
            ...
            modelBuilder.Entity("Ettad.Data.Entities.Accessory", b =>
                {
                    b.Navigation("WeaponAccessories");
                });
