    ...
    public class UserDelegationService : IUserDelegationService, IDelegationAuthorizationService
    {
        ...
        private UserDelegationDto MapToDto(UserDelegation entity, string currentUserId)
        {
            ...
            return new UserDelegationDto
            {
                ...
                DelegatorFullNameEn = entity.DelegatorUser?.FullNameEN,
                DelegatorFullNameAr = entity.DelegatorUser?.FullNameAR,
                DelegatorMilitaryId = entity.DelegatorUser?.MilitoryId,
                ...
                DelegateeFullNameEn = entity.DelegateeUser?.FullNameEN,
                DelegateeFullNameAr = entity.DelegateeUser?.FullNameAR,
                DelegateeMilitaryId = entity.DelegateeUser?.MilitoryId,
