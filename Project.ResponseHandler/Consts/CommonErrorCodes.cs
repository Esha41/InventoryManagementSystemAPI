...
namespace Ettad.ResponseHandler.Consts
{
    public class CommonErrorCodes : IErrorCodes
    {
        ...
        public static readonly CommonErrorCodes SESSION_CONFLICT = new CommonErrorCodes("SESSION_CONFLICT", CommonErrorCode.SESSION_CONFLICT);
